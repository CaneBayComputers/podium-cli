...
pre_install() {
    docker exec zeltro-mariadb mariadb -u root -e "CREATE DATABASE IF NOT EXISTS roundcube CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;"
}
...
services:
  roundcube-app:
    ...
    environment:
      ...
      ROUNDCUBEMAIL_DB_HOST: zeltro-mariadb
      ROUNDCUBEMAIL_DB_PORT: 3306
      ROUNDCUBEMAIL_DB_NAME: roundcube
      ROUNDCUBEMAIL_DB_USER: root
      ROUNDCUBEMAIL_DB_PASSWORD: ""
      ROUNDCUBEMAIL_SMTP_SERVER: zeltro-mailhog
