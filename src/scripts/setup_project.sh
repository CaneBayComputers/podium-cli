...
usage() {
    echo "Usage: $0 <project_name> [database_engine] [display_name] [description] [emoji] [options]"
    echo "Sets up a project in the projects directory"
    echo ""
    echo "Arguments:"
    echo "  project_name     Name of the project to setup"
    echo "  database_engine  Database type: mysql, postgres, mongo (default: mysql)"
    echo "  display_name     Display name for project (optional)"
    echo "  description      Project description (optional)"
    echo "  emoji            Project emoji (default: 🚀)"
    echo ""
    echo "Options:"
    ...
    echo "  --php-version VERSION   Force specific PHP version (7 or 8)"
    echo ""
    echo "Examples:"
