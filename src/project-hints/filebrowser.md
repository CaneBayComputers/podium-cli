...
- On first boot with an empty database it runs "quick setup" and logs: `User 'admin' initialized with randomly generated password: ...`. Read it with `zeltro logs` / `docker logs`.
...
- The installer exists: run `zeltro install filebrowser`.
