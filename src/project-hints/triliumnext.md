...
- This is a different project from the older `trilium` installer; the two can coexist as separate Zeltro projects but do not share a data volume.
- The installer exists: run `zeltro install triliumnext`.
