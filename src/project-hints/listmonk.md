...
- Env uses double-underscore prefix: `LISTMONK_db__host=zeltro-postgres`, `LISTMONK_db__port=5432`, `LISTMONK_db__user=root`, `LISTMONK_db__password=password`, `LISTMONK_db__database=listmonk`.
- Set admin user via: `LISTMONK_ADMIN_USER=admin`, `LISTMONK_ADMIN_PASSWORD=admin12345`.
- The installer exists: run `zeltro install listmonk`.
