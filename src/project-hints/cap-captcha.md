...
**Database**: Redis only (`zeltro-redis`, db 9, key prefix `cap:`)
**Credentials**: admin key `zeltro-cap-admin-key` — that string *is* the dashboard login
...
- The installer exists: run `zeltro install cap-captcha`.
