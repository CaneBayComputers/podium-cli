...
## Key Notes
- Env: `PAPERLESS_DBHOST=zeltro-postgres`, `PAPERLESS_DBPORT=5432`, `PAPERLESS_DBUSER=root`, `PAPERLESS_DBPASS=password`, `PAPERLESS_DBNAME=paperless`, `PAPERLESS_REDIS=redis://zeltro-redis:6379`.
...
- The installer exists: run `zeltro install paperless`.
