...
**Database**: MariaDB (`zeltro-mariadb`, database `booklore`, user `booklore`/`booklore`)
**Credentials**: Create the admin account on first visit

## Key Notes
- The connection string is JDBC, not a URL: `jdbc:mariadb://zeltro-mariadb:3306/booklore`.
...
- The installer exists: run `zeltro install booklore`.
