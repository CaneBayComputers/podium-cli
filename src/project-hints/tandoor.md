...
## Key Notes
- Env: `DB_ENGINE=django.db.backends.postgresql`, `POSTGRES_HOST=zeltro-postgres`, `POSTGRES_PORT=5432`, `POSTGRES_USER=root`, `POSTGRES_PASSWORD=password`, `POSTGRES_DB=tandoor`.
...
- The installer exists: run `zeltro install tandoor`.
