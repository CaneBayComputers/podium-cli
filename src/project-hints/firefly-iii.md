...
- Create DB before start: `docker exec zeltro-mariadb mariadb -u root -e "CREATE DATABASE IF NOT EXISTS firefly;"`
...
- The installer exists: run `zeltro install firefly-iii`.
